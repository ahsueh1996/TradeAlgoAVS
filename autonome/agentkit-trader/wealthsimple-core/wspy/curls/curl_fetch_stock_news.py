...
curl 'https://my.wealthsimple.com/graphql' \
  ...
  --data-raw '{"operationName":"FetchSecurityNews","variables":{"securityId":"sec-s-27167ecbd81140fe9cdc02535f43174d","from":"2024-12-14"},"query":"query FetchSecurityNews($securityId: String, $from: String) {\n  securityNews(query: {ids: [$securityId], metadata: {from: $from}}) {\n    title\n    image\n    url\n    publishedAt\n    source\n    symbols\n    __typename\n  }\n}"}'

From field isn't necessary... 
"""
...
cookies = {
    ...
    '_dd_s': 'rum=0&expire=1739055723519',
}
...
headers = {
    ...
    'priority': 'u=1, i',
    'referer': 'https://my.wealthsimple.com/app/security-details/sec-s-27167ecbd81140fe9cdc02535f43174d?tab=equity',
...
json_data = {
    'operationName': 'FetchSecurityNews',
    'variables': {
        'securityId': 'sec-s-27167ecbd81140fe9cdc02535f43174d',
        'from': '1111-11-11',
    },
    'query': 'query FetchSecurityNews($securityId: String, $from: String) {\n  securityNews(query: {ids: [$securityId], metadata: {from: $from}}) {\n    title\n    image\n    url\n    publishedAt\n    source\n    symbols\n    __typename\n  }\n}',
}
...
#data = '{"operationName":"FetchSecurityNews","variables":{"securityId":"sec-s-27167ecbd81140fe9cdc02535f43174d","from":"2024-12-14"},"query":"query FetchSecurityNews($securityId: String, $from: String) {\\n  securityNews(query: {ids: [$securityId], metadata: {from: $from}}) {\\n    title\\n    image\\n    url\\n    publishedAt\\n    source\\n    symbols\\n    __typename\\n  }\\n}"}'
...
""" Expected response
{
    "data": {
        "securityNews": [
            {
                "title": "EXCLUSIVE: How High Will S&P 500 Go Under Donald Trump In 2025? Readers Are Optimistic, 26% Say This...",
                "image": "",
                "url": "https://www.benzinga.com/etfs/broad-u-s-equity-etfs/25/01/43041374/exclusive-how-high-will-sp-500-go-under-donald-trump-in-2025-readers-are-optimistic-26?utm_source=TechInvestorNews&utm_campaign=partner_feed&utm_medium=partner_feed&utm_content=site",
                "publishedAt": "2025-01-16T21:32:00.000+00:00",
                "source": "Benzinga",
                "symbols": [
                    "SPY.XNYS"
                ],
            ...
            {
                "title": "Blackrock's Bitcoin ETF Could Outshine SandP 500-Tracking SPY To Become Top Investment Vehicle But It Will Take A and#039;Long' Time, Says Prominent Analyst",
                "image": "",
                "url": "https://www.benzinga.com/analyst-ratings/analyst-color/24/12/42666635/blackrocks-bitcoin-etf-could-outshine-sp-500-tracking-spy-to-become-top-investment-?utm_source=TechInvestorNews&utm_campaign=partner_feed&utm_medium=partner_feed&utm_content=site",
                "publishedAt": "2024-12-24T09:23:00.000+00:00",
                "source": "Benzinga",
                "symbols": [
                    "SPY.XNYS"
                ],
