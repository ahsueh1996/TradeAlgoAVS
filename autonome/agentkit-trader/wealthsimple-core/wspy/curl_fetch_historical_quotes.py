...
curl 'https://my.wealthsimple.com/graphql' \
  ...
  --data-raw $'{"operationName":"FetchSecurityHistoricalQuotes","variables":{"timerange":"5y","id":"sec-s-27167ecbd81140fe9cdc02535f43174d"},"query":"query FetchSecurityHistoricalQuotes($id: ID\u0021, $timerange: String\u0021 = \\"1d\\") {\\n  security(id: $id) {\\n    id\\n    historicalQuotes(timeRange: $timerange) {\\n      ...HistoricalQuote\\n      __typename\\n    }\\n    __typename\\n  }\\n}\\n\\nfragment HistoricalQuote on HistoricalQuote {\\n  adjustedPrice\\n  currency\\n  date\\n  securityId\\n  time\\n  __typename\\n}"}'
...
cookies = {
    ...
    '_dd_s': 'rum=0&expire=1739055854616',
}
...
json_data = {
    'operationName': 'FetchSecurityHistoricalQuotes',
    'variables': {
        'timerange': '5y',
        'id': 'sec-s-27167ecbd81140fe9cdc02535f43174d',
    },
    'query': 'query FetchSecurityHistoricalQuotes($id: ID!, $timerange: String! = "1d") {\n  security(id: $id) {\n    id\n    historicalQuotes(timeRange: $timerange) {\n      ...HistoricalQuote\n      __typename\n    }\n    __typename\n  }\n}\n\nfragment HistoricalQuote on HistoricalQuote {\n  adjustedPrice\n  currency\n  date\n  securityId\n  time\n  __typename\n}',
}
...
#data = '{"operationName":"FetchSecurityHistoricalQuotes","variables":{"timerange":"5y","id":"sec-s-27167ecbd81140fe9cdc02535f43174d"},"query":"query FetchSecurityHistoricalQuotes($id: ID!, $timerange: String! = \\"1d\\") {\\n  security(id: $id) {\\n    id\\n    historicalQuotes(timeRange: $timerange) {\\n      ...HistoricalQuote\\n      __typename\\n    }\\n    __typename\\n  }\\n}\\n\\nfragment HistoricalQuote on HistoricalQuote {\\n  adjustedPrice\\n  currency\\n  date\\n  securityId\\n  time\\n  __typename\\n}"}'
